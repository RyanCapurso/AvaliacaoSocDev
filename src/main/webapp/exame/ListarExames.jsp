              ...
              <tr>
                ...
                <td class="text-end">
                  <s:url action="editarExames" var="editar">
                    <s:param name="exameVo.idExame" value="idExame"></s:param>
                  </s:url>
                  ...
                  <s:url action="excluirExames" var="excluirUrl">
                    <s:param name="exameVo.idExame" value="%{idExame}" />
                  </s:url>
                  ...
                  <a
                    ...
                    data-bs-target="#confirmarExclusao-${idExame}"
                  >
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <s:form action="excluirExames" method="post">
                            <s:hidden
